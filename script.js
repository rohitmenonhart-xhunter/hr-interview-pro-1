document.addEventListener('DOMContentLoaded', () => {
    ...
    uploadButton.addEventListener('click', async () => {
        ...
        try {
            ...
            const response = await axios.post('https://hr-interview-server-f3-1ysl.onrender.com/generate_questions', formData, {
        ...
        if (finalTranscription) {
            try {
                ...
                if (isFollowUp) {
                    ...
                    const response = await axios.post('https://hr-interview-server-f3-1ysl.onrender.com/generate_follow_up', {
    ...
    concludeInterview.addEventListener('click', async () => {
        try {
            stopRecording();
            const response = await axios.post('https://hr-interview-server-f3-1ysl.onrender.com/generate_feedback', {
    ...
    async function getTTSUrl(text) {
        try {
            ...
            const response = await axios.post('https://hr-interview-server-f3-1ysl.onrender.com/tts', { text: cleanedText }, {
                responseType: 'blob'
            });
